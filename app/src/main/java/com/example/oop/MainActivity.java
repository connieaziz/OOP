...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Car toyota = new Car("White", "Toyota", 4, 200);
        Car hybreed = new Car("blue","Hybreed", 4,180);
        Car mercedes = new Car("Black", "AMG", 4, 200);
        Car austine = new Car("blue", "austine", 2,240);
        ...
        taxi.hoot();
        taxi.stop();
        Log.d("Taxi taxi","taxi speed at" +taxi.getSpeed());

        Sportscar sportsCar = new Sportscar("Red", "Ferrari", 2, 100);
        sportsCar.accelerate(80);
        Log.d("SportsCar", "Ferrari.speed" +sportsCar.getSpeed());
        sportsCar.hoot();
        sportsCar.hoot("vuuuuuuum");
